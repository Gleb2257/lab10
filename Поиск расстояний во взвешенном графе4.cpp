...
void calculateRadiusDiameterAndClasses(const vector<vector<int>>& dist) {
    int n = dist.size();
...
int main() {
    ...
    calculateRadiusDiameterAndClasses(undirectedDist);
    ...
    calculateRadiusDiameterAndClasses(directedDist);
